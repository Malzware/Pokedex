...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pokemon_evolutions', function (Blueprint $table) {
            ...
            $table->foreignId('pokemon_veriety_id')->constrained('pokemon_varieties')->onDelete('cascade'); // Clé étrangère vers pokemon_varieties
            ...
            $table->foreignId('know_move_id')->nullable()->constrained('moves')->onDelete('set null'); // Clé étrangère vers moves (nullable)
            $table->foreignId('know_move_type_id')->nullable()->constrained('types')->onDelete('set null'); // Clé étrangère vers types (nullable)
            ...
            $table->boolean('need_overworld_rain')->default(false); // Pluie nécessaire dans le monde (default false)
            $table->foreignId('party_species_id')->nullable()->constrained('pokemons')->onDelete('set null'); // Clé étrangère vers pokemons (nullable)
            ...
            $table->foreignId('trade_species_id')->nullable()->constrained('pokemons')->onDelete('set null'); // Clé étrangère vers pokemons (nullable)
